...
public class VisitController {
    ...
    public ResponseEntity<VisitReservationDetailDto> reserveVisit(@RequestBody VisitReservationDto visitReservationDto) {
        ...
        List<VisitPosition> visitPositions = visitPositionService.addVisitPositions(visitEntity, serviceTypeIds);

        VisitDto visitDTO = mapToVisitDTO(visitEntity, user.getId());
        List<VisitPositionDetailDto> visitPositionDetails = mapToVisitPositionDetails(visitPositions, serviceTypes);
    ...
    private List<VisitPositionDetailDto> mapToVisitPositionDetails(List<VisitPosition> visitPositions, List<ServiceTypeDto> serviceTypes) {
        return visitPositions.stream()
                .map(vp -> {
