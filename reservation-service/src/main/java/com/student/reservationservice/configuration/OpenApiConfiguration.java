package com.student.reservationservice.configuration;
...
public class OpenApiConfiguration {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                ...
                .info(
                        new Info()
                                .title("Reservation Service APIs")
                                .description("This lists all the Reservation Service API Calls. The Calls are OAuth2 secured")
                                .version("v1.0")
                )
                .components(
                        new Components()
